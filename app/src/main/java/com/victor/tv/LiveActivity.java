...
public class LiveActivity extends BaseActivity implements TvRecyclerView.OnItemListener,
    ...
    private TvRecyclerView mTrvChannel;
    ...
    Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case LOAD_MORE_DATA:
                    channelAdapter.appendDatas(getMovietDatas(20)); //加载数据
                    mTrvChannel.setLoadingMore(false); //加载数据完毕
                    mTrvChannel.setHasMoreData(true);
                    break;
            }
        }
    };
    ...
    private void initialize () {
        mTrvChannel = (TvRecyclerView) findViewById(R.id.trv_channel);
        // 设置布局的横纵间距
        mTrvChannel.setSpacingWithMargins(10, 0);
        channelAdapter = new ChannelAdapter(this);
        channelAdapter.setDatas(getMovietDatas(20));
        mTrvChannel.setAdapter(channelAdapter);
    ...
    private void setListener() {
        mTrvChannel.setOnItemListener(this);
        //边界监听
        mTrvChannel.setOnInBorderKeyEventListener(this);
        mTrvChannel.setOnLoadMoreListener(this);
    }
    ...
    public boolean onLoadMore() {
        ...
        mTrvChannel.setLoadingMore(true); //正在加载数据
