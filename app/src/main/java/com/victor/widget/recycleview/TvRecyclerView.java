package com.victor.widget.recycleview;
...
public class TvRecyclerView extends RecyclerView implements View.OnClickListener, View.OnFocusChangeListener{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mHasFocusWithPrevious = mHasFocusWithPrevious || hasFocus();
         Loger.i(getClass().getSimpleName(),"onLayout...start hasFocus()="+mHasFocusWithPrevious + " changed="+changed + " ,mShouldReverseLayout="+ mShouldReverseLayout);
        ...
        mHasFocusWithPrevious = false;
         Loger.i(getClass().getSimpleName(),"onLayout...end layoutAfterFocus="+layoutAfterFocus+". used time " + (System.currentTimeMillis() - startMillis) / 1000f + "s");
    }
    
    @Override
    protected void onMeasure(int widthSpec, int heightSpec) {
        long startMillis = System.currentTimeMillis();
         Loger.i(getClass().getSimpleName(),"onMeasure...start");
        super.onMeasure(widthSpec, heightSpec);
         Loger.i(getClass().getSimpleName(),"onMeasure...end. used time " + (System.currentTimeMillis() - startMillis) / 1000f + "s");
    }
    ...
    public void requestChildFocus(View child, View focused) {
         Loger.i(getClass().getSimpleName(),"requestChildFocus... hasFocus="+hasFocus());
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
         Loger.i(getClass().getSimpleName(),"addFocusables3... direction="+direction+" focusableMode="+focusableMode+" hasFocus="+hasFocus());
    ...
    public boolean requestFocus(int direction, Rect previouslyFocusedRect) {
         Loger.i(getClass().getSimpleName(),"direction..."+direction);
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, @Nullable Rect previouslyFocusedRect) {
         Loger.i(getClass().getSimpleName(),"gainFocus="+gainFocus + " hasFocus="+hasFocus()+" direction="+direction);
        if(gainFocus) {
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rect, boolean immediate) {
        ...
        int dy = scrollAmount[1];
         Loger.i(getClass().getSimpleName(),"dx="+dx+" dy="+dy);
    ...
    private int[] getChildRectangleOnScreenScrollAmount1(View child, Rect rect, int offsetStart, int offsetEnd) {
        ...
        if(getLayoutManager().canScrollHorizontally()) {
            ...
            if(!ViewCompat.canScrollHorizontally(this, dx)) {
                 Loger.i(getClass().getSimpleName(),"cannotScrollHorizontally...");
                dx = 0;
            }
        }
        ...
        if(getLayoutManager().canScrollVertically()) {
            ...
            dy = offScreenTop != 0 ? offScreenTop : Math.min(childTop - parentTop, offScreenBottom);
             Loger.i(getClass().getSimpleName(),"dy="+dy);
            if(!ViewCompat.canScrollVertically(this, dy)) {
                 Loger.i(getClass().getSimpleName(),"cannotScrollVertically...");
                dy = 0;
            }
        }
    ...
    private int computeScrollOffset(int start, int end, int offsetStart, int offsetEnd) {
         Loger.i(getClass().getSimpleName(),"start="+start+" end="+end+" offsetStart="+offsetStart+" offsetEnd="+offsetEnd);
    ...
    private boolean hasInBorder(int direction, View nextFocusedView) {
        if(null != nextFocusedView)
            return false;
         Loger.i(getClass().getSimpleName(),"hasInBorder...direction="+direction);
        switch (direction) {
            case FOCUS_DOWN:
    ...
    private class IRecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onChanged() {
             Loger.i(getClass().getSimpleName(),"RecyclerView Data Changed!!!");
            mShouldReverseLayout = true;
        }
    }
    ...
    private class TvSmoothScroller extends LinearSmoothScroller {
        ...
        protected void onStop() {
            ...
            if(mRequestFocus) {
                ...
                if (null != itemView) {
                     Loger.i(getClass().getSimpleName(),"SmoothScroller Top Request Child Focus");
