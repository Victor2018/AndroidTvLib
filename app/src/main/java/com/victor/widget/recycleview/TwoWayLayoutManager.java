...
//        Log.i(LOGTAG, "fillSpecific...position="+position);
    ...
    private void correctTooHigh(int childCount, Recycler recycler, State state) {
        // First see if the last rv_video_cell is visible. If it is not, it is OK for the
    ...
    private void correctTooLow(int childCount, Recycler recycler, State state) {
        // First see if the first rv_video_cell is visible. If it is not, it is OK for the
