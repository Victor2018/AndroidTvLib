...
public class XmlKeyboardLoader {
	...
	public SoftKeyboard loadKeyboard(int resourceId) {
		Loger.d(getClass().getSimpleName(),"loadKeyboard loading ... ...");
		...
		try {
				...
				if (mXmlEventType == XmlResourceParser.START_TAG) {
					...
					if (XMLTAG_KEYBOARD.compareTo(attr) == 0) { // keyboard
						...
						if (softKeyboard == null) {
							Loger.e(getClass().getSimpleName(),"XMLTAG_ROW softKeyboard null");
							return null;
						}
						...
						if (null == splitter || null == labels) {
							Loger.e(getClass().getSimpleName(),"XMLTAG_KEYS splitter or labels null");
							return null;
						}
						...
						if (null == softKeyboard) {
							Loger.e(getClass().getSimpleName(),"XMLTAG_KEY softKeyboard null");
							return null;
						}
			...
			Loger.d(getClass().getSimpleName(),"loadKeyboard load over");
			return softKeyboard;
		} catch (XmlPullParserException e) {
			e.printStackTrace();
			Loger.e(getClass().getSimpleName(),"loadKeyboard XmlPullParserException " + e.getMessage());
		} catch (IOException e) {
			e.printStackTrace();
			Loger.e(getClass().getSimpleName(),"loadKeyboard IOException " + e.getMessage());
		} finally {
			if (xrp != null)
				xrp.close();
		}
