...
import com.victor.tv.library.widget.keyboard.SoftKey.SaveSoftKey;
...
public class SoftKeyboardView extends View {
    ...
    protected void onDraw(Canvas rootCanvas) {
        ...
        if (mCacheBitmap == null) {
            Loger.d(getClass().getSimpleName(),"onDraw mCacheBitmap:" + mCacheBitmap);
    ...
    private void drawSoftKey(Canvas canvas, SoftKey softKey, boolean isDrawState) {
        if (softKey == null) {
            Loger.e(getClass().getSimpleName(),"softKey is null...");
            return;
        }
        // 绘制按键背景.
    ...
    public void setSoftKeyPress(boolean isPress) {
        if (mSoftKeyboard == null) {
            Loger.e(getClass().getSimpleName(),"setSoftKeyPress isPress:" + isPress);
            return;
        }
    ...
    public boolean moveToNextKey(int direction) {
        if (mSoftKeyboard == null) {
            Loger.e(getClass().getSimpleName(),"moveToNextKey mSoftKeyboard is null");
            return false;
        }
        ...
        if (keyRow == null) {
            Loger.e(getClass().getSimpleName(),"moveToNextKey keyRow is null");
            return false;
        }

        List<SoftKey> softKeys = keyRow.getSoftKeys();
        if (softKeys == null) {
            Loger.e(getClass().getSimpleName(),"moveToNextKey keyRow -> softKeys is null");
            return false;
        }
