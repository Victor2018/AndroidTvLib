package com.victor.tv.library.widget;
...
import com.victor.tv.library.util.AppUtil;
import com.victor.tv.library.util.BitmapMemoryCache;
import com.victor.tv.library.util.DrawUtils;
    ...
    public void draw(Canvas canvas) {
        try {
            if (canvas != null) {
                ...
                } else if (AppUtil.getSDKVersion() == 17) {
