package com.victor.tv.library.widget.keyboard;
...
public class SkbContainer extends RelativeLayout implements SoftKeyBoardable {
	...
	private boolean setKeyCodeEnter(SoftKey softKey) {
		if (softKey == null) {
			Loger.e(getClass().getSimpleName(),"setKeyCodeEnter softKey is null");
			return false;
		}
	...
	public boolean onSoftKeyDown(int keyCode, KeyEvent event) {
		...
		Loger.d(getClass().getSimpleName(),"onSoftKeyDown keyCode:" + keyCode);
		switch (keyCode) {
		...
		case KeyEvent.KEYCODE_DPAD_CENTER:
			...
			Loger.d(getClass().getSimpleName(),"onSoftKeyDown softKey:" + softKey);
		...
		default:
			Loger.d(getClass().getSimpleName(),"onSoftKeyDown false keyCode:" + keyCode);
			return false;
		}
		Loger.d(getClass().getSimpleName(),"onSoftKeyDown true keyCode:" + keyCode);
		return true;
	}
	...
	public boolean onSoftKeyUp(int keyCode, KeyEvent event) {
		...
		Loger.d(getClass().getSimpleName(),"onSoftKeyUp keyCode:" + keyCode);
		if (mSoftKeyboardView != null)
			mSoftKeyboardView.setSoftKeyPress(false);
		switch (keyCode) {
		case KeyEvent.KEYCODE_ENTER:
		...
		case KeyEvent.KEYCODE_DPAD_DOWN: // 下
		case KeyEvent.KEYCODE_BACK:
			Loger.d(getClass().getSimpleName(),"onSoftKeyUp true keyCode:" + keyCode);
			return true;
		}
		Loger.d(getClass().getSimpleName(),"onSoftKeyUp false keyCode:" + keyCode);
		return false;
	}
